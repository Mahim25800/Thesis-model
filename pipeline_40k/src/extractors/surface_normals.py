    ...
    def extract(
        ...
        if self.use_foundation:
            ...
            with torch.no_grad():
                ...
                normals_tensor = self.normal_head(feats, h, w)  # [1, 3, H, W]
                normals = normals_tensor.squeeze(0).permute(1, 2, 0).cpu().numpy()  # [H, W, 3]

            # Estimate dominant light direction l from intensity-weighted normals
            ...
            # Fallback high-resolution geometric normal map
