...
def train_model(
    ...
    print("-" * 75)
    print(f"Training completed. Best AUC: {best_auc:.4f}. Model saved to {best_model_path}")
    ...
    print("\n" + format_evaluation_summary(sub_results["overall"], title="Cross-Generator Unseen Test Evaluation (Overall)"))
    print("\n" + "=" * 65)
